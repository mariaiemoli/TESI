...
public:
	...
	*/ 
	...
	TriangleData getIntersectionTriangle () const
	{
		return M_intersectionTriangle;
	}
	...
	{
		return M_intersectionTriangle.measure();
	}

	void Resize ( const size_type& i );

	void setPoint ( const size_type& i, const size_type& j);
